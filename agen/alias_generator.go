...
func generateAliases(inputFilePath, outputFilePath string) error {
	...
	fmt.Fprintf(outputStringBuilder, "// Code generated by github.com/collibra/access-governance-go-sdk/generator, DO NOT EDIT.\n\n")
	...
	for _, decl := range file.Decls {
		if d, ok := decl.(*ast.GenDecl); ok {
			handleDeclarationNodes(d, outputStringBuilder, pkgAlias, constAssignments)
		}
	}
...
func handleDeclarationNodes(d *ast.GenDecl, outputStringBuilder *strings.Builder, pkgAlias string, constAssignments map[string][]string) {
